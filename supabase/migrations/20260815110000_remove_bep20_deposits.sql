-- CloudMiner HYIP — прибирає можливість поповнення USDT у мережі BEP20
-- (за проханням користувача). TON, USDT-TON (jetton) і USDT-TRC20
-- лишаються без змін.

-- deposit_intents: знову дозволяємо лише TRC20 -----------------------------
...
-- create_deposit_intent: p_network знову приймає лише TRC20 ----------------
...
-- credit_deposit: прибираємо BEP20 зі списку дозволених мереж -------------
